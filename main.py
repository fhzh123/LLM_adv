...
from task.cls_training import cls_training
from task.adv_training import adv_training
...
if __name__=='__main__':
    ...
    parser.add_argument('--preprocess_path', default=f'/HDD/{user_name}/preprocessed/llm_adv', type=str,
                        help='Pre-processing data path')
    parser.add_argument('--model_save_path', default=f'/HDD/{user_name}/model_checkpoint/llm_adv', type=str,
                        help='Model checkpoint file path')
    parser.add_argument('--result_path', default=f'/HDD/{user_name}/results/llm_adv', type=str,
